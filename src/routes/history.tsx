...
function HistoryPage() {
  ...
  return (
    <main className="min-h-screen w-full px-5 sm:px-8">
      <header className="max-w-4xl mx-auto pt-10 flex items-center justify-between">
      ...
      <section className="max-w-4xl mx-auto py-16">
        <div className="flex items-center gap-4 mb-12">
          ...
          <div>
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight leading-none">Riwayat Belajar</h1>
            <p className="text-muted-foreground text-sm font-medium mt-2">Lacak progres belajarmu di sini.</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-24 glass rounded-[40px] border border-dashed border-border/50">
            ...
            <p className="text-muted-foreground/70 text-sm mt-1 max-w-xs mx-auto px-4">
          ...
          <div className="grid gap-6">
            {history.map((attempt, idx) => (
              <motion.div
                ...
                className="glass-strong p-6 sm:p-8 rounded-[32px] shadow-soft border border-white/20 flex flex-col sm:flex-row sm:items-center justify-between gap-6 group"
              >
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 text-xs font-bold text-muted-foreground mt-2">
                      <span className="flex items-center gap-1.5 py-1 px-3 rounded-full glass border border-white/40">
                ...
                <div className="text-left sm:text-right border-t sm:border-0 pt-4 sm:pt-0">
                  <span className="text-4xl font-black text-primary">{Math.round(attempt.score)}%</span>
